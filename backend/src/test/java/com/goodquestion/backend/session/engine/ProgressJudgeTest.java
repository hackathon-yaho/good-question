...
class ProgressJudgeTest {
    ...
    void 필수요소_충족_및_preferredTurns_도달시_GOAL_MET로_종료() {
        ProgressInput input = new ProgressInput(2, 2, 4, List.of(), false, ResponseMode.NORMAL, 0, 0, false, null, 0);
    ...
    void 필수요소_충족해도_preferredTurns_미달이면_종료하지_않는다() {
        ProgressInput input = new ProgressInput(1, 2, 4, List.of(), true, ResponseMode.NORMAL, 0, 0, false, null, 0);
    ...
    void maxTurns_도달시_missing_남아있어도_MAX_TURNS로_종료() {
        ProgressInput input = new ProgressInput(4, 2, 4, List.of("SOLUTION"), false, ResponseMode.NORMAL, 3, 3, false, null, 0);
    ...
    void 첫_발화는_유도_조건을_만족해도_NORMAL_강제() {
        ProgressInput input = new ProgressInput(1, 4, 6, List.of("SOLUTION"), false, null, 5, 5, false, null, 0);
    ...
    void 이번턴_신규요소_확인시_유도조건_만족해도_NORMAL_강제() {
        ProgressInput input = new ProgressInput(3, 4, 6, List.of("SOLUTION"), true, ResponseMode.NORMAL, 5, 5, false, null, 0);
    ...
    void 직전턴이_GUIDED였으면_유도조건_만족해도_NORMAL_강제() {
        ProgressInput input = new ProgressInput(3, 4, 6, List.of("SOLUTION"), false, ResponseMode.GUIDED, 5, 5, false, null, 0);
    ...
    void 신규요소_없음이_2회_연속이면_GUIDED() {
        ProgressInput input = new ProgressInput(3, 4, 6, List.of("SOLUTION"), false, ResponseMode.NORMAL, 2, 0, false, null, 0);
    ...
    void 저정보_발화가_2회_연속이면_GUIDED() {
        ProgressInput input = new ProgressInput(3, 4, 6, List.of("SOLUTION"), false, ResponseMode.NORMAL, 0, 2, false, null, 0);
    ...
    void 남은_턴이_2_이하면_GUIDED() {
        ProgressInput input = new ProgressInput(4, 10, 6, List.of("SOLUTION"), false, ResponseMode.NORMAL, 0, 0, false, null, 0);
    ...
    void missing이_없으면_정체_조건이_충족돼도_GUIDED가_아니다() {
        ProgressInput input = new ProgressInput(2, 10, 6, List.of(), false, ResponseMode.NORMAL, 5, 5, false, null, 0);
    ...
    void 유도조건_어느것도_해당없으면_NORMAL() {
        ProgressInput input = new ProgressInput(2, 10, 10, List.of("SOLUTION"), false, ResponseMode.NORMAL, 0, 0, false, null, 0);
    ...
    void maxTurns_도달이_첫_발화_NORMAL_강제보다_우선한다() {
        ...
        ProgressInput input = new ProgressInput(1, 10, 1, List.of("SOLUTION"), false, null, 0, 0, false, null, 0);
    ...
    void GOAL_MET_조건이어도_미공개_미션이_있으면_maxTurns_전까지_종료를_미룬다() {
        ProgressInput input = new ProgressInput(2, 2, 4, List.of(), false, ResponseMode.NORMAL, 0, 0, true, null, 0);
    ...
    void 미공개_미션이_있어도_maxTurns_도달하면_MAX_TURNS로_종료한다() {
        ProgressInput input = new ProgressInput(4, 2, 4, List.of("SOLUTION"), false, ResponseMode.NORMAL, 3, 3, true, null, 0);
    ...
    void 미션_활성_최소턴_미달이면_필수요소_충족해도_GOAL_MET으로_닫지_않는다() {
        ...
        ProgressInput input = new ProgressInput(9, 2, 4, List.of(), false, ResponseMode.NORMAL, 0, 0, false, 3, 0);
    ...
    void 미션_활성_최소턴_충족하면_필수요소_충족시_GOAL_MET으로_닫는다() {
        ProgressInput input = new ProgressInput(9, 2, 4, List.of(), false, ResponseMode.NORMAL, 0, 0, false, 3, 1);
    ...
    void 미션_활성_최대턴_미달이면_원래_maxTurns를_넘겨도_MAX_TURNS로_닫지_않는다() {
        ...
        ProgressInput input = new ProgressInput(9, 2, 4, List.of("SOLUTION"), false, ResponseMode.NORMAL, 3, 3, false, 3, 3);
    ...
    void 미션_활성_최대턴_도달하면_원래_maxTurns보다_한참_전이어도_MAX_TURNS로_닫는다() {
        ...
        ProgressInput input = new ProgressInput(4, 2, 4, List.of("SOLUTION"), false, ResponseMode.NORMAL, 3, 3, false, 1, 4);

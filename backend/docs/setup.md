...
| 소셜 로그인 | 카카오 (단독) | D-06 |
| STT / TTS | OpenAI `gpt-4o-transcribe`(D-46, 이전 whisper-1→gpt-4o-mini-transcribe) · OpenAI TTS | D-01 |
...
| `OPENAI_API_KEY` | **STT(`gpt-4o-transcribe`) · TTS 전용** | 백엔드 담당 키 (D-16). AI 서버 키와 별개 |

...
RESPOND_PROMPT_VERSION = "respond_v8"
...
4. 막연한 당위("잘해 줘야 해요")나 한두 낱말 답은 SHORT다. 이유·장면 내용 없이 거절·회피·
   거친 말만 한
...
7. GUIDED일 때는 remainingWorry의 핵심 대상·상황을 캐릭터 자신의 걱정 하나로 반드시 드러낸다.
   ...
   요구하지 않는다.
8. `unclearUtterance`의 짧은 거절·회피·거친 말에는 무응답·꾸짖음·욕설 되풀이를 하지 않는다.
   - "싫어" 같은 거절: 하기 싫을 수 있음을 짧게 받아주고, 캐릭터 걱정과 이어지는 장면 질문 하나로
     다시 참여할 길을 준다.
   - "닥쳐" 같은 거친 말: 훈계하지 말고 답답한 마음을 짧게 받아준 뒤, 캐릭터의 구체적 걱정과 장면
     질문 하나로 전환한다.

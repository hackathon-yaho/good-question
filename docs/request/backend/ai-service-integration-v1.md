...
> **시간 제한·재시도 정책은 [AI 호출 재시도·시간 예산 v4](ai-retry-deadline-v4.md)로 대체됩니다.**
...
- 응답 시간·재시도: [v4 요청](ai-retry-deadline-v4.md)의 Worker 전체 102초·백엔드 105초·최초 포함 최대 10회 정책을 따른다.

...
4. 첫 저정보 발화는, 남은 기회 부족 조건이 아니라면 기존처럼 NORMAL로 짧고 비판하지 않게
   반응할 수 있다. 두 번째 연속 저정보 발화는 첫 보호 GUIDED가 된다.
...
| --- | --- | --- | --- | --- | --- |
| 1 | `싫어` | NORMAL | 1 | 0 | 미종료 |
| 2 | `싫어` | GUIDED | 1 | 1 | 미종료, `/respond` 호출 |
| 3 | `싫어` | GUIDED | 1 | 2 | 미종료, 다음 장면 이동 없음 |
